...
router.post('/', authMiddleware, roleMiddleware(['ADMIN', 'HR']), validateJobPosting, async (req, res) => {
...
router.put('/:id', authMiddleware, roleMiddleware(['ADMIN', 'HR']), validateJobPosting, async (req, res) => {
  const { id } = req.params;
